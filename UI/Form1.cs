...
namespace UI
{
    public partial class Form1 : Form
    {
        ...
        private void btnAñadirBorrador_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ActualizarCampos();
                MessageBox.Show($"Pelicula cargada al borrador correctamente. Cantidad de peliculas en espera: {listaBorrador.Count}", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
