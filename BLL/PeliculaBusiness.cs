...
namespace BLL
{
    public class PeliculaBusiness
    {
        ...
        public void cargarPelicula(Pelicula pelicula)
        {
            try
            {
                using(var trx = new TransactionScope())
                {
                    ...
                    if (pelicula.Categoria.IdCategoria <= 0)
                    {
        ...
        public void cargarMultiplesPeliculas(List<Pelicula> listaPeliculas)
        {
            try
            {
                using(var trx = new TransactionScope())
                {
                    ...
                    {
                        throw new Exception("No hay peliculas en el borrador");
                    }
